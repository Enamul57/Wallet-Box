...
<head>
    ...
    <link href="{{Vite::asset('resources/css/sb-admin-2.min.css')}}" rel="stylesheet">
...
<body id="page-top">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class=" py-2 sub_menu rounded">
                        <a href="{{route('admin.package_management')}}">
                            <span>Package Create</span></a>
                        <a href="{{route('admin.package_lists')}}">
                            <span>Package Lists</span></a>
                    </div>
                </div>
            </li>
        </ul>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="{{Vite::asset('resources/img/undraw_profile.svg')}}">
                            </a>
    ...
    <script src="{{Vite::asset('resources/js/demo/chart-area-demo.js')}}"></script>
    <script src="{{Vite::asset('resources/js/demo/chart-pie-demo.js')}}"></script>
