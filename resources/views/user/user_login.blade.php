...
<body class="bg-gradient-primary">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                @if(url()->previous()===route('user_register.get'))
                                    @if(session('message'))
                                ...
                                @endif
                                @if(session('approval_warn'))
                                    <div class="alert alert-warning">
                                        {{session('approval_warn')}}
                                    </div>
                                @endif
                                <div class="p-5">
                                    ...
                                    <form class="user" action='{{route('user_login.post')}}' method='POST'>
                                        @csrf
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="{{route('user_register.get')}}">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script src="{{Vite::asset('resources/vendor/jquery/jquery.min.js')}}vendor/jquery/jquery.min.js"></script>
