                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                @if(url()->previous()===route('admin_register.get'))
                                    @if(session('message'))
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" action='{{route('admin_login.post')}}' method='POST'>
                                        @csrf
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="{{route('admin_register.get')}}">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
